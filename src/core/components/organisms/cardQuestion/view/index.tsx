  ...
  return (
    <Card theme={theme} style={styles(theme).container}>
      ...
      <View style={styles(theme).buttons}>
        <Buttons.Link alignCenter theme={theme} onPress={onPressTrue}>TRUE</Buttons.Link>
        <Buttons.Link alignCenter theme={theme} onPress={onPressFalse}>FALSE</Buttons.Link>
      </View>
    </Card>
  )
}
